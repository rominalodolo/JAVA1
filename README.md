...
Then add the project name to the `Name: ` secion. Use the `com.example..` for the main class and you can choose `Apply`/`OK`.
![settingconfing](https://user-images.githubusercontent.com/83961643/160576473-01452e95-a959-41b9-be97-b1e543ddb36c.jpeg)
